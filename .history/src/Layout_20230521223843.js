            ...
            <div className="w-1/4">
              <div className="profile  bg-gray-100  h-max  pt-5 pb-7 rounded-lg">
                <div className="name ">
                  ...
                  <div className="t text-center flex">
                    <button className=" my-4 m-auto mx-7 border-solid border-2 border-indigo-600 rounded-lg p-2  bg-yellow-500 hover:bg-amber-800 ">
                      <h4>Download Cv</h4>
