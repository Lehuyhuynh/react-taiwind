    ...
    <div>
      <div id="resume">
        ...
        <div className="row">
           ...
           <div className="owl-carousel row" data-items="3" data-autoplay="3000" data-pagination="true">
              <div className="item">
              ...
              <div className="item">
                <div className="comment">
                  ...
                  <hr />
                    <p>Henry is a very creative and talented designer. I do not hesitate to work again.g</p>
                </div>
              </div>
