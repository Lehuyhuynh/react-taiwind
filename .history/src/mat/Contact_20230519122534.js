      ...
      <div id="contact">
        <div className="row ">
          ...
          <section className="contact-form w-3/6">
            <div className="section-title" style={{marginBottom:"20px"}}><span></span><h2>Contact Form</h2>
          ...
          <secction className="contact-info">
            <div className="section-title  " style={{marginBottom:"20px"}}><span></span><h2>Contact Informations</h2>
            <div className='my-6' style={{height:"7px", width :"93px", backgroundColor:"#FFBF00", marginTop:"-10px"}}></div></div>
            <ul>
          ...
          <section className="contact-map">
            <div className="section-title text-lg"><span></span><h2>Contact Map.</h2>
            <div className='my-6' style={{height:"7px", width :"93px", backgroundColor:"#FFBF00", marginTop:"-10px"}}></div></div>
