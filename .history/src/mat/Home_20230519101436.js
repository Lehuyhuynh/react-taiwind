    ...
    <div id="home " style={{margin:"20px"}}>
       ...
       <div className="row bg-white my-8  ">
        <section className="services">
          <div className="section-title " style={{marginTop:"30px"}}><span><h2 className='text-lg'>My Services</h2></span>
          <div style={{height:"7px", width :"78px", backgroundColor:"#FFBF00", marginTop:"-18px"}}></div>
          </div>
