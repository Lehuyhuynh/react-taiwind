        ...
        <div className="row">
          <section className="education">
            ...
            <div className="row flex">
              ...
              <div className="w-[1px] h-[300px] bg-slate-600 mt-20 ml-3 left-8 relative"></div>
                <ul className="timeline ml-2.5 mt-7 mr-1.5">
                  ...
                  <li className='mb-6 flex'>
                    <div className="ml-[1.25rem]  h-2 w-[1.375rem] bg-orange-400 rounded-full relative z"></div>
                    <div className="ml-2">
