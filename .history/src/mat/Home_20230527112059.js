...
const Home = () => {
  return (
    <div id="home " >
       <div className="row pb-8" style={{margin: '0 20px'}}>
        <section className="about-me">
          <div className="section-title  "><h2 className='text-lg '>About Me</h2>
          <div className='mb-7' style={{height:"7px", width :"78px", backgroundColor:"#FFBF00", marginTop:"-10px"}}></div>
          </div>
       ...
       <div className="row bg-white py-8  ">
        <section className="services">
          <div className="section-title  pl-[20px]" ><span><h2 className='text-lg'><span className='mt-[20px]'>My Services</span></h2></span>
          <div className='my-7' style={{height:"7px", width :"93px", backgroundColor:"#FFBF00", marginTop:"-10px"}}></div>
          </div>
       ...
       <div className="row flex pt-8 " style={{margin: '0 20px'}}>
         <section className="design-skills w-3/6">
            <div className="section-title text-lg"><span></span><h2>Design Skills</h2>
            <div className='my-6' style={{height:"7px", width :"93px", backgroundColor:"#FFBF00", marginTop:"-10px"}}></div></div>
              <ul className="skill-list">
                <li>
                  <h3>Photoshop</h3>
                  <div className="progress w-80 h-2 bg-white rounded-lg">
                    <div className="percentege h-2 bg-orange-400 w-3/4 "></div>
                  </div>
                </li>
                ...
                <li> 
                  <h3>Sketch</h3>
                  <div className="progress w-80 h-2 bg-white rounded-lg">
                    <div className="percentege h-2 bg-orange-400 w-2/4"></div>
                  </div>
                </li>
                ...
                <li>
                  <h3>Adobe Xd</h3>
                  <div className="progress w-80 h-2 bg-white rounded-lg">
                    <div className="percentege h-2 bg-orange-400 w-1/4"></div>
                  </div>
                </li>
         ...
         <div className="section-title text-lg"><span></span><h2>Code Skills</h2>
         <div className='my-6' style={{height:"7px", width :"80px", backgroundColor:"#FFBF00", marginTop:"-10px"}}></div></div>
              <ul className="skill-list">
                <li>
                  <h3>Javascript</h3>
                  <div className="progress w-80 h-2 bg-white rounded-lg">
