        ...
        <div className="row ">
          ...
          <secction className="contact-info">
            ...
            <ul>
              ...
              <li className='mb-2.5'><span>Skype:</span> chrisjohnson85</li>
              <li>
                <div class="social-icons top_15"> 
                  <a className="fb mr-2" href="#"><i class="fa-brands fa-facebook"></i></a> 
                  <a className="tw mr-2" href="#"><i class="fa-brands fa-twitter"></i></a> 
                  <a className="ins mr-2" href="#"><i class="fa-brands fa-instagram"></i></a> 
