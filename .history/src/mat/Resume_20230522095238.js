            ...
            <div className="row flex">
              ...
              <div className="education-history pb-7">
                <ul className="timeline ml-2.5 mt-7">
                  <li className='flex mb-8'>
                  <div className='ml-[1.25rem] bg-yellow-500 py-3 px-4 rounded-full	'><i class="fa-solid fa-graduation-cap"></i></div>
                  <h2 className="time-title"> Education History </h2>
                  </li>

                  <li className='mb-6 flex' >
                  <div className="h-2 w-[1.375rem] bg-orange-400 rounded-full"></div>
                  <div className="ml-2">
