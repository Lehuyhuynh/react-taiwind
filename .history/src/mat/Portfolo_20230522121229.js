        ...
        <div className="content-header">
          ...
          <div id="grip-container" className="grid  grid-cols-3 grid-rows-3 mb-5  ">
            ...
            <div className="cbp-item border-8 rounded-lg bg-white group">
              <a className='cbp-single' href="">
                <figure>
                  <div className="icon3 text-center text-2xl absolute text-black font-bold letter-[2px] bottom-0 left-1/2 opacity-0 translate-x-[-2/4] ease-in-out text-white py-[10px] px-[15px] min-w-[50px] rounded-full bg-orange-500 hover:left-[43%] hover:opacity-100">
