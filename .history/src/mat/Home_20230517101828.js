                  ...
                  <nav>
                    <div className="row">
                      ...
                      <div className="col-md-4 col-sm-4 col-xs-8 dynamic">
                        <button className=" my-5 ml-5 my-0 mr-1.5 bg-amber-500">Hire Me
                        <i class="fa fa-paper-plane bg-white text-zinc-950 ml-3.5" aria-hidden="true" className="bg-white text-zinc-950 ml-3.5 "></i>
                        </button>
                      </div>
                    </div>
                  </nav>
