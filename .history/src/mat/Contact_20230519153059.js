      ...
      <div id="contact">
        <div className="row ">
          ...
          <section className="contact-form w-3/6">
            ...
            <div className='my-6' style={{height:"7px", width :"100px", backgroundColor:"#FFBF00", marginTop:"-10px"}}></div></div>
            <form action="site-form">
              <div className="row">
                ...
                <div className="t">
                  <button className="site-btn m-4 border-solid border-2 border-indigo-600 rounded-lg" type="submit">Submit</button>
                </div>
          ...
          <secction className="contact-info">
            ...
            <div className='my-6' style={{height:"7px", width :"1px", backgroundColor:"#FFBF00", marginTop:"-10px"}}></div></div>
            <ul>
              ...
              <li>
                <div class="social-icons top_15"> 
                  <a className="fb mr-3" href="#"><i class="fa-brands fa-facebook"></i></a> 
                  <a className="tw mr-3" href="#"><i class="fa-brands fa-twitter"></i></a> 
                  <a className="ins mr-3" href="#"><i class="fa-brands fa-instagram"></i></a> 
                  <a className="dr" href="#"><i class="fa-brands fa-dribbble"></i></a> 
                </div>
              </li>
            </ul>
          </secction>
