            ...
            <div className="row flex">
              <div className="working-history pb-7">
                <ul className="timeline ml-2.5 mt-7 mr-1.5">
                  ...
                  <div className='bg-white py-3 px-4 rounded-full	'><i class="fa-solid fa-suitcase"></i></div>
              ...
              <div className="education-history pb-7">
                <ul className="timeline ml-2.5 mt-7">
                  <li className='flex mb-8'>
                  <div className='bg-white py-3 px-4 rounded-full	'><i class="fa-solid fa-graduation-cap"></i></div>
