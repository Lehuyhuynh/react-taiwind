    ...
    <div id="home " style={{margin:"20px"}}>
       <div className="row my-8">
        <section className="about-me">
          <div className="section-title"><h2 className='text-7xl'>About Me</h2>
          <div style={{height:"7px", width :"70px", backgroundColor:"#FFBF00", marginTop:"-10px"}}></div>
          </div>
       ...
       <div className="row bg-white my-8  ">
        <section className="services">
          <div className="section-title " style={{marginTop:"30px"}}><span><h2 style={{marginTop:"30px"}}>My Services</h2></span></div>
