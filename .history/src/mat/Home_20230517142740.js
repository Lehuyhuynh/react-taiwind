          ...
          <div className="row  ">
            <div className="col-lg-3 col-md-4 flex">
              <div className="profile w-1/4 bg-gray-300 h-max" >
                <div className="name " style={{padding:"10px 15px"}}>
                  <h3 style={{padding:"10px 15px"}} >HENRY ROONEY </h3>
                  <span style={{padding:"10px 15px"}}>Creative Designer</span>
                  <img
                    src="https://html.tavonline.co/mat/default/images/profile.jpg" className="w"
                    alt=""
                  />
                  <ul>
                    <li></li>
              ...
              <div id="home   ">
                ...
                <footer className="bg-slate-600 ">
                  <div className="footer col-md-12 top_30 bottom_30 flex">
