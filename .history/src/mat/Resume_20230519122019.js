      ...
      <div id="resume" style={{margin:"20px"}}>
        <div className="row">
          <section className="education">
            <div className="section-title"><span></span><h2>Resume</h2>
        ...
        <div className="row">
          <section className="clients">
            <div className="section-title"><span></span><h2>Clients</h2>
            <div className='my-6' style={{height:"7px", width :"93px", backgroundColor:"#FFBF00", marginTop:"-10px"}}></div></div>
            <div className="row flex">
              <div className="t">
        ...
        <div className="row">
           ...
           <div className="section-title"><span></span><h2>Testimonials</h2>
           <div className='my-6' style={{height:"7px", width :"93px", backgroundColor:"#FFBF00", marginTop:"-10px"}}></div></div>
           <div className="owl-carousel row flex" data-items="3" data-autoplay="3000" data-pagination="true">
              ...
              <div className="item">
                <div className="comment">
                  <div className="top-section">
                    <figure>
                     <img className='rounded-full w-2/6' src="https://html.tavonline.co/mat/default/images/testimonial-1.jpg" alt="" />
                    </figure>
