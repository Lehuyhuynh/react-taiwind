  ...
  return (
    <div>
      <div id="resume "   >
        <div className="row" style={{margin: '0 30px'}}>
          <section className="education pb-8">
            ...
            <div className="row flex">
              ...
              <div className="w-[1px] h-[392px] bg-slate-300 mt-[40px]  ml-3 left-8 relative ml-[-15px]"></div>
                <ul className="timeline ml-2.5 mt-7 mr-1.5">
                  
                  <li className='flex mb-8 '>
                  <div className='bg-yellow-500 py-3 px-4 rounded-full  relative	'><i class="fa-solid fa-suitcase"></i></div>
              ...
              <div className="w-[1px] h-[392px] bg-slate-300 mt-[40px] ml-3 left-8 relative"></div>
                <ul className="timeline ml-2.5 mt-7">
                  <li className='flex mb-8'>
                  <div className=' bg-yellow-500 py-3 px-4 rounded-full relative	'><i class="fa-solid fa-graduation-cap"></i></div>
        ...
        <div className="row border bg-gray-100" style={{background: 'white'}}>
          <section className="clients py-8 pl-[25px] pr-[25px]">
            ...
            <div className="row flex grid gap-4 grid-cols-4 ">
              <div className="py-[16px] px-[16px] bg-white border rounded-lg">
                <div className="client w-[142px]">
                  <img src="https://html.tavonline.co/mat/default/images/client-01.jpg" alt="" />
                </div>
              </div>

              <div className="py-[16px] px-[16px] white border rounded-lg">
                <div className="client  w-[142px]">
        ...
        {/* Testimonials */}
        <div className="row pt-8" style={{margin: '0 30px'}}>
