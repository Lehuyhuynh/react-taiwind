        ...
        <div className="row">
          <section className="education">
            ...
            <div className="row flex">
              ...
              <div className="w-[1px] h-[300px] bg-slate-600 mt-20 ml-3"></div>
                <ul className="timeline ml-2.5 mt-7 mr-1.5">
                  
                  <li className='flex mb-8 '>
                  <div className='bg-yellow-500 py-3 px-4 rounded-full left: 33px	'><i class="fa-solid fa-suitcase"></i></div>
