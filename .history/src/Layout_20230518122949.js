              ...
              <div className="row">
                ...
                <header className="bg-gray-100 h-16 rounded-lg">
                  <nav className="flex">
                    ...
                    <div className="hidden-md social-icons pull-right flex mr-28 ">
                       <a  className="fb mr-1 m-4  hover:text-amber-500" href="fb ">
                       <i class="fa-brands fa-facebook"></i>
                       </a>

                       <a className="fb mr-1 m-4" href="tw">
                       <i class="fa-brands fa-twitter"></i>
                       </a>

                       <a className="fb mr-1 m-4" href="ins">
                       <i class="fa-brands fa-instagram"></i>
                       </a>

                       <a className="fb mr-1 m-4" href="dr">
