                ...
                <header className="bg-gray-100 h-16 rounded-lg">
                  <nav className="flex">
                    ...
                    <div className="hidden-md social-icons pull-right flex ml-28 h-16 mr-[20px]">
                      <a
                        className="fb  my-5  hover:text-indigo-600"
                        href="fb "
                      >
                      ...
                      <a
                        className="fb  my-5  hover:text-indigo-300"
                        href="tw"
                      >
                        <i class="fa-brands fa-twitter" style={{fontSize:}}></i>
                      </a>

                      <a
                        className="fb  my-5  hover:text-red-500"
                        href="ins"
                      >
                      ...
                      <a
                        className="fb  my-5   hover:text-amber-200"
                        href="dr"
                      >
                        <i class="fa-brands fa-dribbble"></i>
                      </a>

                      <div className="my-5  border-solid border-2  rounded-lg bg-yellow-500 hover:bg-amber-800  ">
                        <a
