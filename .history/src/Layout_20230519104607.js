          ...
          <div className="row flex">
            ...
            <div className="ajax-tab-container  w-3/4  ml-5">
              <div className="row">
                ...
                <div className=" mt-6 bg-gray-100 rounded-lg m-w-auto">
                  <br />
                  <Outlet />
                </div>
                ...
                <footer className="">
                  <div className="footer flex bg-black rounded-lg w-full h-16">
                    <div className="name text-slate-100 m-4">Henry Rooey</div>
                    <div className="copyright ">
                    <span className="text-slate-400 m-4"> © 2017 All rights reserved. Designed by</span>
                     
                      <a  className="text-slate-100 m-4 hover:text-cyan-400" href="https://themeforest.net/user/tavonline">
                        {" "}
                        tavonline{" "}
                      </a>
                    </div>
