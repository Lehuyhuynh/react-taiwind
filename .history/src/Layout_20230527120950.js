                ...
                <header className="bg-gray-100 h-16 rounded-lg">
                  <nav className="flex">
                    ...
                    <div className="hidden-md social-icons pull-right flex ml-28 h-16 mr-[20px]">
                      <a
                        className="fb  my-5 mx-3  hover:text-indigo-600"
                        href="fb "
                      >
                      ...
                      <a
                        className="fb  my-5 mx-3  hover:text-indigo-300"
                        href="tw"
                      >
                      ...
                      <a
                        className="fb  my-5 mx-3 hover:text-red-500"
                        href="ins"
                      >
                      ...
                      <a
                        className="fb  my-5  mx-3 hover:text-amber-200"
                        href="dr"
                      >
                        <i class="fa-brands fa-dribbble" style={{fontSize:'12px'}}></i>
                      </a>

                      <div className="my-5 mx-3 border-solid border-2  rounded-lg bg-yellow-500 hover:bg-amber-800  ">
                        <a
