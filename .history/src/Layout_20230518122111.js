                ...
                <header className="bg-gray-100 h-16 rounded-lg">
                  <nav className="flex">
                    ...
                    <div className="hidden-md social-icons pull-right flex ">
                       <a  className="fb mr-3 m-4" href="fb ">
                       <i class="fa-brands fa-facebook"></i>
                       </a>

                       <a className="fb mr-3 m-4" href="tw">
                       <i class="fa-brands fa-twitter"></i>
                       </a>

                       <a className="fb mr-3 m-4" href="ins">
                       <i class="fa-brands fa-instagram"></i>
                       </a>

                       <a className="fb mr-5 m-4" href="dr">
                       <i class="fa-brands fa-dribbble"></i>
                       </a>

                       <div>
                       <a href="mailto:hi@tavonline.net" 
                      className="pull-right site-btn icon hidden-xs m-4">Hire Me 
