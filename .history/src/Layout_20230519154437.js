      ...
      <div className="wrapper my-14 mx-auto">
        <div className="container px-3.5 mx-auto w-3/5">
          <div className="row flex">
            <div className="w-1/4">
              <div className="profile  bg-gray-100  h-max  pt-2.5">
                <div className="name ">
                  <h3 className="mx-5 mr-4 mt-2.5">HENRY ROONEY</h3>
                ...
                <header className="bg-gray-100 h-16 rounded-lg">
                  <nav className="flex">
                    ...
                    <div className="hidden-md social-icons pull-right flex ml-28 ">
                      ...
                      <div className="m-5 border-solid border-2 border-indigo-600 rounded-lg">
                        <a
