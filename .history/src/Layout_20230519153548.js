            ...
            <div className="w-1/4">
              <div className="profile  bg-gray-100  h-max ">
                <div className="name ">
                  ...
                  <div className="t">
                    <button className=" my-4 m-auto mx-7 border-solid border-2 border-indigo-600 rounded-lg ">
                      Download Cv
                ...
                <header className="bg-gray-100 h-16 rounded-lg">
                  <nav className="flex">
                    <ul className="flex ">
                      ...
                      <li className="m-4 hover:text-amber-500">
                    ...
                    <div className="hidden-md social-icons pull-right flex ml-28 ">
                      <a
                        className="fb mr-1 m-4  hover:text-indigo-600"
                        href="fb "
                      >
                      ...
                      <a
                        className="fb mr-1 m-4  hover:text-indigo-300"
                        href="tw"
                      >
                      ...
                      <a
                        className="fb mr-1 m-4  hover:text-red-500"
                        href="ins"
                      >
                      ...
                      <a
                        className="fb mr-1 m-4   hover:text-amber-700"
                        href="dr"
                      >
