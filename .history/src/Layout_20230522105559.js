...
<ul className="m-5 ">
  ...
  <div className=" right-[3px] ml-[1.25rem] h-2 w-[0.5rem] bg-orange-400 rounded-full z-10 relative"></div>
    <h2>Name: <span> Chris Johnson</span></h2>
  </li>
  <li className="mb-5 flex">
  <div className="ml-[1.25rem] h-2 w-[0.65rem] bg-orange-400 rounded-full z-10 relative right-[3px"></div>
    <h2>Birthday: <span>06 December 1987</span></h2>
  </li>
  <li className="mb-5 flex">
  <div className="ml-[1.25rem] h-2 w-[0.65rem] bg-orange-400 rounded-full z-10"></div>
